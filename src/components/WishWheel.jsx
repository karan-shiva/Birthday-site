...
const timelineData = [
  {
    ...
    icon: FaCalendar,
    image: '/Message/Anirudh.avif',
    wishImage: '/Message/Anirudh-msg.avif',
    relatedIds: [6, 2],
    energy: 100,
  },
  {
    ...
    icon: FaFileAlt,
    image: '/Message/Disha.avif',
    wishImage: '/Message/Disha-msg.avif',
    relatedIds: [1, 3],
    energy: 85,
  },
  {
    ...
    icon: FaCode,
    image: '/Message/Karan.avif',
    wishImage: '/Message/Karan-msg.avif',
    relatedIds: [2, 4],
    energy: 70,
  },
  {
    ...
    icon: FaUser,
    image: '/Message/Saumya.avif',
    wishImage: '/Message/Saumya-msg.avif',
    relatedIds: [3, 5],
    energy: 55,
  },
  {
    ...
    icon: FaClock,
    image: '/Message/Shivani-1.avif',
    wishImage: '/Message/Shivani-1-msg.avif',
    relatedIds: [4, 6],
    energy: 40,
  },
  {
    ...
    icon: FaCalendar,
    image: '/Message/Shivani-2.avif',
    wishImage: '/Message/Shivani-2-msg.avif',
    relatedIds: [5, 1],
    energy: 10,
  },
]
